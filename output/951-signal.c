/Users/wpf/Desktop/log/test/linux-2.6.9/arch/arm/kernel/signal.c
asmlinkage int 
{
...
static int
{
get_user_error(magic0, iwmmxt_storage+0, err);
get_user_error(magic1, iwmmxt_storage+1, err);
get_user(dummy, iwmmxt_storage+IWMMXT_STORAGE_SIZE/4-1)) {
}
static int
{
...
get_user_error(regs->ARM_cpsr, &sc->arm_cpsr, err);
}
